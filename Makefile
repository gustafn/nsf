...
PKG_LIB_FILE	= libxotcl1.5.7.dylib
PKG_STUB_LIB_FILE = libxotclstub1.5.7.a
...
pkgdatadir	= /usr/local/aolserver-4.5/share/xotcl1.5.7
pkglibdir	= /usr/local/aolserver-4.5/lib/xotcl1.5.7
pkgincludedir	= /usr/local/aolserver-4.5/include/xotcl1.5.7
...
EXTRA_CFLAGS	=  -DXOTCLVERSION=\"1.5\" -DXOTCLPATCHLEVEL=\".7\" 	 -DHAVE_TCL_COMPILE_H=1
