...
# installed directory.
XOTCL_INCLUDE_DIR="/usr/include/xotcl1.3.1"
XOTCL_INCLUDE_SPEC="-I$XOTCL_INCLUDE_DIR"

# The name of the XOTcl library (may be either a .a file or a shared library):
XOTCL_LIB_FILE=libxotcl1.3.1.so

# String to pass to linker to pick up the XOTcl library from its
# build directory.
XOTCL_BUILD_LIB_SPEC='-L/home/neumann/xotcl-1.3.1 -lxotcl1.3.1'

# String to pass to linker to pick up the XOTcl library from its
# installed directory.
XOTCL_LIB_SPEC='-L/usr/lib/xotcl1.3.1 -lxotcl1.3.1'

# The name of the XOTcl stub library (a .a file):
# XOTCL_STUB_LIB_FILE=libxotclstub1.3.1.a

# String to pass to linker to pick up the XOTcl stub library from its
# build directory.
XOTCL_BUILD_STUB_LIB_SPEC='-L/home/neumann/xotcl-1.3.1 -lxotclstub1.3.1'

# String to pass to linker to pick up the XOTcl stub library from its
# installed directory.
XOTCL_STUB_LIB_SPEC='-L/usr/lib/xotcl1.3.1 -lxotclstub1.3.1'

# Name of the xotcl stub library with full path in build and install directory
XOTCL_BUILD_STUB_LIB_PATH='/home/neumann/xotcl-1.3.1/libxotclstub1.3.1.a'
XOTCL_STUB_LIB_PATH='/usr/lib/xotcl1.3.1/libxotclstub1.3.1.a'
...
XOTCL_SHARED_LIB_SUFFIX=1.3.1.so
XOTCL_UNSHARED_LIB_SUFFIX=1.3.1.a
