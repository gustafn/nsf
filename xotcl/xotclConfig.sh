...
XOTCL_BUILD_INCLUDE_DIR='/home/neumann/xotcl-1.3.0/generic'
XOTCL_BUILD_INCLUDE_SPEC="-I${XOTCL_BUILD_INCLUDE_DIR}"

# String to pass to compiles to pick up the XOTcl includes from their
# installed directory.
XOTCL_INCLUDE_DIR="/usr/include/xotcl1.3.0"
XOTCL_INCLUDE_SPEC="-I$XOTCL_INCLUDE_DIR"

# The name of the XOTcl library (may be either a .a file or a shared library):
XOTCL_LIB_FILE=libxotcl1.3.0.so

# String to pass to linker to pick up the XOTcl library from its
# build directory.
XOTCL_BUILD_LIB_SPEC='-L/home/neumann/xotcl-1.3.0 -lxotcl1.3.0'

# String to pass to linker to pick up the XOTcl library from its
# installed directory.
XOTCL_LIB_SPEC='-L/usr/lib/xotcl1.3.0 -lxotcl1.3.0'

# The name of the XOTcl stub library (a .a file):
# XOTCL_STUB_LIB_FILE=libxotclstub1.3.0.a

# String to pass to linker to pick up the XOTcl stub library from its
# build directory.
XOTCL_BUILD_STUB_LIB_SPEC='-L/home/neumann/xotcl-1.3.0 -lxotclstub1.3.0'

# String to pass to linker to pick up the XOTcl stub library from its
# installed directory.
XOTCL_STUB_LIB_SPEC='-L/usr/lib/xotcl1.3.0 -lxotclstub1.3.0'

# Name of the xotcl stub library with full path in build and install directory
XOTCL_BUILD_STUB_LIB_PATH='/home/neumann/xotcl-1.3.0/libxotclstub1.3.0.a'
XOTCL_STUB_LIB_PATH='/usr/lib/xotcl1.3.0/libxotclstub1.3.0.a'
...
XOTCL_SRC_DIR='/home/neumann/xotcl-1.3.0'

# shared and unshared library suffix
XOTCL_SHARED_LIB_SUFFIX=1.3.0.so
XOTCL_UNSHARED_LIB_SUFFIX=1.3.0.a
