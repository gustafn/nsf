...
# installed directory.
XOTCL_INCLUDE_DIR="/usr/local/include/xotcl1.5.2"
XOTCL_INCLUDE_SPEC="-I$XOTCL_INCLUDE_DIR"

# The name of the XOTcl library (may be either a .a file or a shared library):
XOTCL_LIB_FILE=libxotcl1.5.2.dylib

# String to pass to linker to pick up the XOTcl library from its
# build directory.
XOTCL_BUILD_LIB_SPEC='-L/Users/neumann/src/xotcl-1.5.2 -lxotcl1.5.2'

# String to pass to linker to pick up the XOTcl library from its
# installed directory.
XOTCL_LIB_SPEC='-L/usr/local/lib/xotcl1.5.2 -lxotcl1.5.2'

# The name of the XOTcl stub library (a .a file):
# XOTCL_STUB_LIB_FILE=libxotclstub1.5.2.a

# String to pass to linker to pick up the XOTcl stub library from its
# build directory.
XOTCL_BUILD_STUB_LIB_SPEC='-L/Users/neumann/src/xotcl-1.5.2 -lxotclstub1.5.2'

# String to pass to linker to pick up the XOTcl stub library from its
# installed directory.
XOTCL_STUB_LIB_SPEC='-L/usr/local/lib/xotcl1.5.2 -lxotclstub1.5.2'

# Name of the xotcl stub library with full path in build and install directory
XOTCL_BUILD_STUB_LIB_PATH='/Users/neumann/src/xotcl-1.5.2/libxotclstub1.5.2.a'
XOTCL_STUB_LIB_PATH='/usr/local/lib/xotcl1.5.2/libxotclstub1.5.2.a'
...
XOTCL_SHARED_LIB_SUFFIX=1.5.2.dylib
XOTCL_UNSHARED_LIB_SUFFIX=1.5.2.a
