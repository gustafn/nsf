...
Source:  http://www.xotcl.org/xotcl-1.5.5.tar.gz
...
rm -f $RPM_BUILD_ROOT/usr/lib/libxotcl1.5.5.so
ln -s xotcl1.5.5/libxotcl1.5.5.so $RPM_BUILD_ROOT/usr/lib
...
%_bindir/xotclsh
%_bindir/xowish
%_prefix/lib/xotcl1.5.5
%_prefix/lib/libxotcl1.5.5.so
