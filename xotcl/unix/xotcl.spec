...
Source:  http://www.xotcl.org/xotcl-1.5.6.tar.gz
...
rm -f $RPM_BUILD_ROOT/usr/lib/libxotcl1.5.6.so
ln -s xotcl1.5.6/libxotcl1.5.6.so $RPM_BUILD_ROOT/usr/lib
...
%_bindir/xotclsh
%_bindir/xowish
%_prefix/lib/xotcl1.5.6
%_prefix/lib/libxotcl1.5.6.so
