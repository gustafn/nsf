...
package require XOTcl 2.4
package provide nx::serializer 2.4.0
...
namespace eval ::nx::serializer {
  ...
  ObjectSystemSerializer create xotcl {
    ...
    :object method Class-serialize {o s} {
      ...
      #
      # Check for overloaded accessors generated by the slots and make sure, these are
      # available in the serialized code.
      #
      set slotObjects [nsf::directdispatch $o ::nsf::methods::class::info::slotobjects -type ::nx::Slot]
      foreach so $slotObjects {
        set methodName [namespace tail $so]
        if {[$o info instprocs $methodName] ne ""} {
          #
          # The method was overloaded.
          #
          $s addPostCmd [:method-serialize $o $methodName inst $s]
        }
      }
