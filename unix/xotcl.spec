...
Source:  http://www.xotcl.org/xotcl-2.0.0.tar.gz
...
rm -f $RPM_BUILD_ROOT/usr/lib/libxotcl2.0.0.so
ln -s xotcl2.0.0/libxotcl2.0.0.so $RPM_BUILD_ROOT/usr/lib
...
%_bindir/xotclsh
%_bindir/xowish
%_prefix/lib/xotcl2.0.0
%_prefix/lib/libxotcl2.0.0.so
