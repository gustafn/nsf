...
#define XOTCL_DISALLOWED_ARG_VALUEECHECK	     (XOTCL_ARG_SUBST_DEFAULT|XOTCL_ARG_METHOD|XOTCL_ARG_INITCMD|XOTCL_ARG_RELATION|XOTCL_ARG_SWITCH|XOTCL_ARG_CURRENTLY_UNKNOWN|XOTCL_ARG_IS_CONVERTER)
...
char *XOTclGlobalStrings[] = {
  ...
  "-guard", "__unknown__",
  /* tcl commands */
  "expr", "format", "info", "::tcl::info::frame", "interp", "::tcl::string::is", "rename", "subst",
};
#endif
