 ...
 */
static int
FilterSearchMethod(Tcl_Interp *interp, NsfObject *object, CONST char *filter) {
...
*/
static int
NsfObjInfoCallableMethod(Tcl_Interp *interp, NsfObject *object, 
			 int subcmd, int withMethodtype, int withCallprotection,
			 int withApplication,
