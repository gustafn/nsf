namespace eval ::nsf {
  ...
  #
  # @sub-command proc Returns the name of the currently executing method.
  #
  ...
  #
  # @sub-command calledproc Returns the name of the target method
  ...
  #
  # @sub-command callinglevel Returns the "original" callstack level
