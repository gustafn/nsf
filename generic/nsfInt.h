...
#define NSF_DISALLOWED_ARG_METHOD_PARAMETER	     (NSF_ARG_ALIAS|NSF_ARG_FORWARD|NSF_ARG_INITCMD)
...
#define NSF_DISALLOWED_ARG_VALUECHECK	     (NSF_ARG_SUBST_DEFAULT|NSF_ARG_ALIAS|NSF_ARG_FORWARD|NSF_ARG_INITCMD|NSF_ARG_SWITCH|NSF_ARG_CURRENTLY_UNKNOWN)
