...
# define NSF_DTRACE_OBJECT_CREATE_ENABLED()		unlikely(NSF_OBJECT_CREATE_ENABLED())
...
# define NSF_DTRACE_OBJECT_CREATE(a0, a1)		NSF_OBJECT_CREATE(a0, a1)
...
# define NSF_DTRACE_OBJECT_CREATE_ENABLED()		0
...
# define NSF_DTRACE_OBJECT_CREATE(a0, a1)		{}
...
#define NSF_ARG_CURRENTLY_UNKNOWN	0x000008
#define NSF_ARG_SUBST_DEFAULT		0x000010
#define NSF_ARG_ALLOW_EMPTY		0x000020
#define NSF_ARG_INITCMD		     	0x000040
#define NSF_ARG_ALIAS		     	0x000080
#define NSF_ARG_FORWARD		     	0x000100
#define NSF_ARG_RELATION		0x000200
...
#define NSF_DISALLOWED_ARG_METHOD_PARAMETER	     (NSF_ARG_ALIAS|NSF_ARG_FORWARD|NSF_ARG_INITCMD|NSF_ARG_RELATION)
...
#define NSF_DISALLOWED_ARG_VALUECHECK	     (NSF_ARG_SUBST_DEFAULT|NSF_ARG_ALIAS|NSF_ARG_FORWARD|NSF_ARG_INITCMD|NSF_ARG_RELATION|NSF_ARG_SWITCH|NSF_ARG_CURRENTLY_UNKNOWN)
