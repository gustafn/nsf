...
/* 6 */
EXTERN int		XOTclCreateObject(Tcl_Interp *interp, Tcl_Obj *name,
...
/* 25 */
EXTERN int		XOTclErrInProc(Tcl_Interp *interp, Tcl_Obj *objName,
...
/* 27 */
EXTERN int		XOTclErrBadVal_(Tcl_Interp *interp, char *expected,
				char *value);
#endif
