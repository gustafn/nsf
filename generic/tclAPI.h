...
static int convertToInfomethodsubcmd(Tcl_Interp *interp, Tcl_Obj *objPtr, XOTclParam CONST *pPtr, ClientData *clientData) {
  int index, result;
  static CONST char *opts[] = {"args", "definition", "name", "parameter", "type", "precondition", "postcondition", NULL};
  result = Tcl_GetIndexFromObj(interp, objPtr, opts, "infomethodsubcmd", 0, &index);
  *clientData = (ClientData) index + 1;
  return result;
}
enum InfomethodsubcmdIdx {InfomethodsubcmdNULL, InfomethodsubcmdArgsIdx, InfomethodsubcmdDefinitionIdx, InfomethodsubcmdNameIdx, InfomethodsubcmdParameterIdx, InfomethodsubcmdTypeIdx, InfomethodsubcmdPreconditionIdx, InfomethodsubcmdPostconditionIdx};
...
static int XOTclClassInfoInvarMethodStub(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv []);
...
static int XOTclClassInfoMethodsMethod(Tcl_Interp *interp, XOTclClass *object, int withMethodtype, int withNomixins, int withIncontext, char *pattern);
...
static int XOTclObjInfoCallableMethod(Tcl_Interp *interp, XOTclObject *object, int withWhich, int withMethodtype, int withNomixins, int withIncontext, char *pattern);
...
static int XOTclObjInfoMethodsMethod(Tcl_Interp *interp, XOTclObject *object, int withMethodtype, int withNomixins, int withIncontext, char *pattern);
...
static int
XOTclClassInfoInvarMethodStub(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  parseContext pc;

  if (ArgumentParse(interp, objc, objv, NULL, objv[0], 
                     method_definitions[XOTclClassInfoInvarMethodIdx].paramDefs, 
                     method_definitions[XOTclClassInfoInvarMethodIdx].nrParameters, 
                     &pc) != TCL_OK) {
    return TCL_ERROR;
  } else {
    XOTclClass *class = (XOTclClass *)pc.clientData[0];
    ...
    parseContextRelease(&pc);
    return XOTclClassInfoInvarMethod(interp, class);
...
XOTclClassInfoMethodsMethodStub(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (ArgumentParse(interp, objc, objv, NULL, objv[0], 
    ...
    int withNomixins = (int )pc.clientData[2];
    int withIncontext = (int )pc.clientData[3];
    char *pattern = (char *)pc.clientData[4];

    parseContextRelease(&pc);
    return XOTclClassInfoMethodsMethod(interp, object, withMethodtype, withNomixins, withIncontext, pattern);
...
XOTclObjInfoCallableMethodStub(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (ArgumentParse(interp, objc, objv, NULL, objv[0], 
    ...
    parseContextRelease(&pc);
    return XOTclObjInfoCallableMethod(interp, object, withWhich, withMethodtype, withNomixins, withIncontext, pattern);
...
XOTclObjInfoMethodsMethodStub(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (ArgumentParse(interp, objc, objv, NULL, objv[0], 
    ...
    parseContextRelease(&pc);
    return XOTclObjInfoMethodsMethod(interp, object, withMethodtype, withNomixins, withIncontext, pattern);
...
{"::xotcl::cmd::ClassInfo::invar", XOTclClassInfoInvarMethodStub, 1, {
  {"class", 1, 0, convertToClass}}
},
...
{"::xotcl::cmd::ClassInfo::methods", XOTclClassInfoMethodsMethodStub, 5, {
...
{"::xotcl::cmd::ObjectInfo::callable", XOTclObjInfoCallableMethodStub, 6, {
...
{"::xotcl::cmd::ObjectInfo::methods", XOTclObjInfoMethodsMethodStub, 5, {
  {"object", 0, 0, convertToObject},
  {"-methodtype", 0, 1, convertToMethodtype},
  {"-nomixins", 0, 0, convertToString},
  {"-incontext", 0, 0, convertToString},
